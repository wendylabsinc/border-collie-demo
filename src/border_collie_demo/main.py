...
def build_app_from_env(*, search_policy: SearchPolicy | None = None) -> FastAPI:
    ...
    return create_app(
        ...
        stage_executor=ProductionStageExecutor(
            ...
            search_policy=selected_search_policy,
            approach_forward_mps=hardware_config.approach_forward_mps,
            close_range_mps=hardware_config.close_range_mps,
            final_push_mps=hardware_config.final_push_mps,
            final_push_duration_s=hardware_config.final_push_duration_s,
        ),
