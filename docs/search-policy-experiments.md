...
Release `stage-camera-v24-apple-pear-pipeline-baseline` compares three bounded Target Fruit
...
python3 scripts/fruit_soak.py --host woof.local --runs 10 --seed 2026081104 \
  ...
  --expected-build-label "stage-camera-v24-apple-pear-pipeline-baseline (codex/stage-camera-v21-search-policy-abc)" \
